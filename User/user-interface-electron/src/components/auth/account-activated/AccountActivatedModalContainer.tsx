...
type AccountActivatedModalContainerProps = {
  children: ReactNode;
};
...
export function AccountActivatedModalContainer({ children }: AccountActivatedModalContainerProps) {
  return (
    <div
      ...
      style={SURFACE}
      data-screen="account-activated"
      role="dialog"
      aria-modal="true"
      aria-labelledby="account-activated-title"
    >
      {children}
    </div>
  );
