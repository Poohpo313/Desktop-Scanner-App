...
type ConnectionModalContainerProps = {
  children: ReactNode;
};
...
export function ConnectionModalContainer({ children }: ConnectionModalContainerProps) {
  return (
    <div
      ...
      style={SURFACE}
      data-screen="checking-connection"
      role="dialog"
      aria-modal="true"
      aria-labelledby="checking-connection-title"
      aria-busy="true"
    >
      {children}
    </div>
