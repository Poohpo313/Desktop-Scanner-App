...
const ASSET = null;
const FIGMA_ID = "1307:1805";
const SCREEN_NAME = "SUCESSFULLY DELETED";

export function SucessfullyDeletedScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"sucessfully-deleted"}>
...
export default SucessfullyDeletedScreen;
