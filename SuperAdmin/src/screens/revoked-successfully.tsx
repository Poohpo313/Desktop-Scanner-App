...
const ASSET = null;
const FIGMA_ID = "1578:887";
const SCREEN_NAME = "REVOKED SUCCESSFULLY";

export function RevokedSuccessfullyScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"revoked-successfully"}>
...
export default RevokedSuccessfullyScreen;
