...
const ASSET = null;
const FIGMA_ID = "2167:1192";
const SCREEN_NAME = "EXPORT SUCCESSFULLY";

export function ExportSuccessfully21671192Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"export-successfully-2167-1192"}>
...
export default ExportSuccessfully21671192Screen;
