...
const ASSET = null;
const FIGMA_ID = "1341:1136";
const SCREEN_NAME = "RECOVER ADMINISTRATOR PIN";

export function RecoverAdministratorPinScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"recover-administrator-pin"}>
...
export default RecoverAdministratorPinScreen;
