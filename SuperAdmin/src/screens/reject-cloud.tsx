...
const ASSET = null;
const FIGMA_ID = "1698:2043";
const SCREEN_NAME = "Reject Cloud";

export function RejectCloudScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"reject-cloud"}>
...
export default RejectCloudScreen;
