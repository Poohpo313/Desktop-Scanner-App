...
const ASSET = null;
const FIGMA_ID = "1335:973";
const SCREEN_NAME = "CHANGES SAVED SUCCESSFULLY";

export function ChangesSavedSuccessfullyScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"changes-saved-successfully"}>
...
export default ChangesSavedSuccessfullyScreen;
