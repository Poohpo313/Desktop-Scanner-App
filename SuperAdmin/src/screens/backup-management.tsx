...
const ASSET = "/figma-assets/SETTINGS.jpg";
const FIGMA_ID = "2189:1660";
const SCREEN_NAME = "BACKUP MANAGEMENT";

export function BackupManagementScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"backup-management"}>
