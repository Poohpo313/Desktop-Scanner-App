...
const ASSET = null;
const FIGMA_ID = "1426:904";
const SCREEN_NAME = "SUCESSFULLY DELETED";

export function SucessfullyDeleted1426904Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"sucessfully-deleted-1426-904"}>
...
export default SucessfullyDeleted1426904Screen;
