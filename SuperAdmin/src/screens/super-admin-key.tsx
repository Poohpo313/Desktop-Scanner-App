...
const ASSET = "/figma-assets/LICENSE KEY MANAGEMENT-1.jpg";
const FIGMA_ID = "822:2818";
const SCREEN_NAME = "SUPER ADMIN KEY";

export function SuperAdminKeyScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-key"}>
...
export default SuperAdminKeyScreen;
