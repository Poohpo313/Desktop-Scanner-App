...
const FIGMA_ID = "1341:1051";
const SCREEN_NAME = "SPLASH SCREEN";

export function SplashScreenScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"splash-screen"}>
