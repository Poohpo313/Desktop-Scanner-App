...
const ASSET = null;
const FIGMA_ID = "1860:1668";
const SCREEN_NAME = "SUPER ADMIN SETTINGS";

export function SuperAdminSettings18601668Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-settings-1860-1668"}>
...
export default SuperAdminSettings18601668Screen;
