...
const ASSET = null;
const FIGMA_ID = "1654:1318";
const SCREEN_NAME = "TROUBLESHOOTING FILTER";

export function TroubleshootingFilterScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"troubleshooting-filter"}>
...
export default TroubleshootingFilterScreen;
