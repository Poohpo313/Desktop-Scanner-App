...
const ASSET = null;
const FIGMA_ID = "1752:985";
const SCREEN_NAME = "SUCESSFULLY DELETED";

export function SucessfullyDeleted1752985Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"sucessfully-deleted-1752-985"}>
...
export default SucessfullyDeleted1752985Screen;
