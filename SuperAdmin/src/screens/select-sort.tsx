...
const ASSET = null;
const FIGMA_ID = "1833:1192";
const SCREEN_NAME = "SELECT SORT";

export function SelectSortScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"select-sort"}>
...
export default SelectSortScreen;
