...
const ASSET = null;
const FIGMA_ID = "859:1039";
const SCREEN_NAME = "SUPER ADMIN CLOUD";

export function SuperAdminCloudScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-cloud"}>
...
export default SuperAdminCloudScreen;
