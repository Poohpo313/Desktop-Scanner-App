...
const ASSET = "/figma-assets/ADMIN LOGIN.png";
const FIGMA_ID = "1341:1083";
const SCREEN_NAME = "ADMINISTRATOR PIN";

export function AdministratorPinScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"administrator-pin"}>
...
export default AdministratorPinScreen;
