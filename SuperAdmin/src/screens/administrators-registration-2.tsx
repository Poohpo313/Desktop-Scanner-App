...
const ASSET = null;
const FIGMA_ID = "1468:1156";
const SCREEN_NAME = "ADMINISTRATORS REGISTRATION 2";

export function AdministratorsRegistration2Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"administrators-registration-2"}>
...
export default AdministratorsRegistration2Screen;
