...
const ASSET = null;
const FIGMA_ID = "1438:3780";
const SCREEN_NAME = "SUPER ADMIN SETTINGS";

export function SuperAdminSettings14383780Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-settings-1438-3780"}>
...
export default SuperAdminSettings14383780Screen;
