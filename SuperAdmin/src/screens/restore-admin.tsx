...
const ASSET = null;
const FIGMA_ID = "1539:884";
const SCREEN_NAME = "Restore Admin";

export function RestoreAdminScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"restore-admin"}>
...
export default RestoreAdminScreen;
