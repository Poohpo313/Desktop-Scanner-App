...
const ASSET = null;
const FIGMA_ID = "1752:1013";
const SCREEN_NAME = "Successfully Saved";

export function SuccessfullySavedScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"successfully-saved"}>
...
export default SuccessfullySavedScreen;
