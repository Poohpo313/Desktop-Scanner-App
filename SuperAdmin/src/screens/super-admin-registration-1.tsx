...
const FIGMA_ID = "822:2817";
const SCREEN_NAME = "SUPER ADMIN REGISTRATION 1";

export function SuperAdminRegistration1Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-registration-1"}>
...
export default SuperAdminRegistration1Screen;
