...
const ASSET = null;
const FIGMA_ID = "1803:1540";
const SCREEN_NAME = "NOTIFY USER";

export function NotifyUser18031540Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"notify-user-1803-1540"}>
...
export default NotifyUser18031540Screen;
