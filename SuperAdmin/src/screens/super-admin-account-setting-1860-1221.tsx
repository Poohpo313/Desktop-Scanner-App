...
const ASSET = null;
const FIGMA_ID = "1860:1221";
const SCREEN_NAME = "Super Admin Account Setting";

export function SuperAdminAccountSetting18601221Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-account-setting-1860-1221"}>
...
export default SuperAdminAccountSetting18601221Screen;
