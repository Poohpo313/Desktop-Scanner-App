...
const FIGMA_ID = "859:991";
const SCREEN_NAME = "SUPER ADMIN LOGS";

export function SuperAdminLogsScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-logs"}>
...
export default SuperAdminLogsScreen;
