...
const ASSET = null;
const FIGMA_ID = "1752:969";
const SCREEN_NAME = "Admin profile delete";

export function AdminProfileDeleteScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"admin-profile-delete"}>
...
export default AdminProfileDeleteScreen;
