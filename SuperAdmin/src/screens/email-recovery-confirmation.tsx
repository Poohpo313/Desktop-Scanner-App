...
const ASSET = null;
const FIGMA_ID = "1341:1224";
const SCREEN_NAME = "EMAIL RECOVERY CONFIRMATION";

export function EmailRecoveryConfirmationScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"email-recovery-confirmation"}>
...
export default EmailRecoveryConfirmationScreen;
