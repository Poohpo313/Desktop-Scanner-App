...
const ASSET = null;
const FIGMA_ID = "1709:1009";
const SCREEN_NAME = "Reject Cloud";

export function RejectCloud17091009Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"reject-cloud-1709-1009"}>
...
export default RejectCloud17091009Screen;
