...
const ASSET = "/figma-assets/USER MANAGEMENT USER REGISTER MODAL.jpg";
const FIGMA_ID = "2076:1193";
const SCREEN_NAME = "REGISTER ADMIN";

export function RegisterAdminScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"register-admin"}>
