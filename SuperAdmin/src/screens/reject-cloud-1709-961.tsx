...
const ASSET = null;
const FIGMA_ID = "1709:961";
const SCREEN_NAME = "Reject Cloud";

export function RejectCloud1709961Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"reject-cloud-1709-961"}>
...
export default RejectCloud1709961Screen;
