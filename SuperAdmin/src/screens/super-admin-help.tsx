...
const ASSET = "/figma-assets/HELP AND SUPPORT CENTER-1.jpg";
const FIGMA_ID = "896:942";
const SCREEN_NAME = "SUPER ADMIN HELP";

export function SuperAdminHelpScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"super-admin-help"}>
...
export default SuperAdminHelpScreen;
