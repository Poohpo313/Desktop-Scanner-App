...
const ASSET = null;
const FIGMA_ID = "1709:945";
const SCREEN_NAME = "SUCESSFULLY DELETED";

export function SucessfullyDeleted1709945Screen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"sucessfully-deleted-1709-945"}>
...
export default SucessfullyDeleted1709945Screen;
