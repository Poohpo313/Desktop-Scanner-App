...
const ASSET = null;
const FIGMA_ID = "894:1780";
const SCREEN_NAME = "REGISTERED SUCCESSFULLY";

export function RegisteredSuccessfullyScreen() {
  const nodeId = FIGMA_ID.replace(":", "-");
  return (
    <main className="figma-screen" data-figma-id={FIGMA_ID} data-screen={"registered-successfully"}>
...
export default RegisteredSuccessfullyScreen;
