import type { DemoKeyListRow } from "./demoKeys";
...
export function buildFigmaKeyCatalogRows(total: number): DemoKeyListRow[] {
  return Array.from({ length: total }, (_, index) => {
    const { getFigmaKeyListRow } = require("./demoKeys") as typeof import("./demoKeys");
    return getFigmaKeyListRow(index);
  });
}
